...
const listOfSocialNetWorks: SocialNetwork[] = [
  {
    name: 'Github',
    description:
      'I use it for personal projects or to contribute to open source',
    icon: <AiFillGithub />,
    href: GITHUB_URL
  },
  {
    name: 'Gitlab',
    description:
      'I use it for my work, this is where I contribute most of the time.',
    icon: <FaGitlab />,
    href: GITLAB_URL
  },
  {
    name: 'Stack Overflow',
    description:
      'Search for solutions and contribute to the community with my questions and answers.',
  ...
  },
  {
    name: 'Linkedin',
    description:
      'I use it to interact with other profiles, it is a very good social network for work.',
    icon: <AiFillLinkedin />,
    href: LINKEDIN_URL
  },
  {
    name: 'Mail',
    description:
      'I use it to communicate with other people. You can send a email to contact with me :)',
    icon: <AiOutlineMail />,
...
const CardSocialNetworks = ({
  ...
  return (
    <Card
      className="rounded-xl cursor-pointer mb-4 w-72"
      effectDirection="y"
      role="link"
