...
export const Tooltip = ({ children, tooltipMessage, isOnClick, isOnHover, defaultState = false }: TooltipProps) => {
    ...
    return (
        <div onMouseOver={onChangeToolTip} onMouseOut={onChangeToolTip} onClick={onChangeToolTip}>
            {children}
            {showToolTip && (
