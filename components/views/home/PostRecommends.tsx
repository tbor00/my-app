...
const PostRecommend = ({ postTitle, publishedDate, readingTime }: PostRecommendProps) => {
    return (
        <Card className="cursor-pointer mt-8 mb-8 rounded-2xl">
            <div className="mb-4">
                <div className="border-b border-dashed mb-4 border-gray-400 pb-4">
                    <Button variant="buttonLink" className="border-blue-400 border flex items-center gap-2">
...
export const PostRecommends = () => {
    return (
        <section id="recommends" className="my-32 px-4">
            ...
            <PostRecommend postTitle="React vs Nextjs, what is the beast Framework today?" publishedDate={new Date()} readingTime={10} />
            <PostRecommend postTitle="Migrate to zustand right now!" publishedDate={new Date()} readingTime={45} />
